...
urlpatterns = patterns('',
	...
	url(r'^dataset/(?P<user_id>[a-z]+)/(?P<dataset_id>\d+)/(?P<max_depth>\d+)/connectivity/datasets/(?P<dummy_user_id>[a-z]+)/(?P<dummy_dataset_id>\d+)/(?P<dummy_max_depth>\d+)/$', getDataset, name='getDataset'),
)
