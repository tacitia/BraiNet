...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      return "<li class=\"" + (classes.join(' ')) + "\"" + style + " data-option-array-index=\"" + option.array_index + "\">" + option.html + "</li>";
    };
    ...
    AbstractChosen.prototype.winnow_results = function() {
	  ...
	  var f = new Fuse(this.results_data, fuseOptions);
      var option, regex, regexAnchor, results, searchText, startpos, text, zregex, _i, _len, _ref;

      this.no_results_clear();
      results = 0;
      searchText = this.get_search_text(); 
      _ref = searchText? f.search(searchText) : this.results_data;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (!option.empty) { //1
          ...
          if (!(option.group && !this.group_search)) {//2
