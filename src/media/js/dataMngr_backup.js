...
// Todo: update dataset info (isClone and origin)
getBrodmannAreas();
...
function deleteNode(nodeKey) {
    ...
    $.ajax({
        ...
        data: {nodeKey: nodeKey, isClone: isClone, origin: origin, userID: userId},
        error: function(data) {
        console.log("Failed");
            console.log(data);
        },
...
function deleteLink(linkKey) {
    ...
    $.ajax({
        ...
        data: {linkKey: linkKey, isClone: isClone, origin: origin},
        error: function(data) {
        console.log("Failed");
            console.log(data);
        },
